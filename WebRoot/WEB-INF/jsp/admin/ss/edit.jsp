...
<input type="hidden" value="${param.flag }" name="flag"/>
			...
			<center>
				...
				<tr height="25">
					...
					<td class="outDetail2">
						<input type="text" id="ssName" value="${map.ssName }" name="ssName"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<input type="text" id="sg" value="${map.sg }" name="sg"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<input type="text" id="zcw" value="${map.zcw }" name="zcw"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<input type="text" id="sycw" value="${map.sycw }" name="sycw"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
