...
<html>
	<body>
		<display:table name="list"
			...
			<display:column title="宿舍编号" property="ssName"/>
			<display:column title="宿管" property="sg"/>
			<display:column title="总床位额" property="zcw"/>
			<display:column title="宿舍床位" property="sycw"/>
