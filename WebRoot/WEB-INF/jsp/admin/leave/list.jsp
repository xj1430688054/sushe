...
<html>
	<body>
		<display:table name="list"
			...
			<display:column title="晚归" property="wgstatus"/>
			<display:column title="晚归状态" property="remark"/>
			
			
			<display:column title="晚归审批" style="width:40px;">
			<c:if test="${row.wgstatus=='晚归'  }">
