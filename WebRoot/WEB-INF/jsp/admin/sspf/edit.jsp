...
<input type="hidden" value="${param.flag }" name="flag"/>
			...
			<center>
				...
				<tr height="25">
					...
					<td class="outDetail2">
						<input id="df" type="text" value="${map.df }" name="df"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<input  readonly="readonly" name="dfDate" id="dfDate" value="<fmt:formatDate value="${map.dfDate }" type="date" pattern="yyyy-MM-dd"/>" type="text" onClick="WdatePicker()"/>
					</td>
				</tr>
		<c:if test="${1==1 }"></c:if>
