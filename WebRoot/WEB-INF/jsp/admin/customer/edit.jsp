...
<input type="hidden" value="${param.flag }" name="flag"/>
			...
			<center>
				...
				<tr height="25">
					...
					<td class="outDetail2">
						<input type="text" id="zw" value="${map.zw }" name="zw"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<input type="text" id="zwsm" value="${map.zwsm }" name="zwsm"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
				...
				<tr height="25">
					...
					<td class="outDetail2">
						<select id="jsId" name="jsId">
							<c:forEach items="${jsList }" var="lists">
								<option value="${lists.id }" ${map.jsId==lists.id?'selected':'' }>${lists.jsName
									}</option>
							</c:forEach>
					</select>
					</td>
