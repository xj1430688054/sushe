...
<input type="hidden" value="${param.flag }" name="flag"/>
			...
			<center>
				...
				<tr height="25">
					...
					<td class="outDetail2">
						<select id="ssId" name="ssId">
							<c:forEach items="${ssList }" var="lists">
								<option value="${lists.id }" ${map.ssId==lists.id?'selected':'' }>${lists.ssName
									}</option>
							</c:forEach>
					</select>
					</td>
				...
				<tr height="25">
					...
					<td class="outDetail2">
						<input type="text" id="shqk" value="${map.shqk }" name="shqk"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<select id="isxf" name="isxf">
								<option value="是" ${map.isxf=='是'?'selected':'' }>是</option>
								<option value="否" ${map.isxf=='否'?'selected':'' }>否</option>
					</select>
					</td>
				</tr>
				<tr height="25">
					...
					<td class="outDetail2">
						<input readonly="readonly" name="beginDate" id="beginDate" value="<fmt:formatDate value="${map.beginDate }" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>" type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<input readonly="readonly" name="endDate" id="endDate" value="<fmt:formatDate value="${map.endDate }" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>" type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
