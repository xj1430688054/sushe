	...
	<form id="form1" name="form1" action="" method="post">
		...
		<center>
			<table class="mobile" style="width: 95%;">
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">职务： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text" id="zw"
						value="${map.zw }" name="zw" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">职务说明： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text" id="zwsm"
						value="${map.zwsm }" name="zwsm" /></td>
				</tr>
